...
class RecommendMovieListPage extends StatefulWidget {
  ...
  String userid;
  String session_id;
  RecommendMovieListPage(this.recommendmovielists,this.userid,this.session_id);
  @override
  RecommendMovieListPageState createState() => RecommendMovieListPageState(recommendmovielists:recommendmovielists,userid: userid,session_id: session_id);
}

class RecommendMovieListPageState extends State<RecommendMovieListPage> {
  RecommendMovieListPageState({Key key, this.recommendmovielists,this.userid,this.session_id}) : super();
  ...
  void getNetmovielistData(Map<String,dynamic> value) {
    Future.wait([
      ...
      for (int i = 0; i < value["movie_id"].length; i++) {
        ...
        Future(() => getmovie(value["movielist_id"],value["movie_id"][i].toString()));
      }
    }).catchError((e) {
      print(e);
    });
              ...
              onTap: () {
                ...
                if (map[value["movielist_id"]].toString() != "") {
                  Navigator.of(context).push(MaterialPageRoute(builder: (_) =>
                      RecommendMovieListDetail(map[value["movielist_id"]],userid,session_id)));
                }
              },
              child: Container(
                width: rpx(200),
