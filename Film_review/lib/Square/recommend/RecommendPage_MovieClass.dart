class Movie{
  ...
  Movie(this.movie_id,this.movie_name,this.movie_picture,this.director,this.scriptwriter,
      this.main_performer,this.movie_type,this.producer_country,this.language,this.release_date,
