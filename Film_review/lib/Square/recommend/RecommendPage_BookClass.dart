class Book{
  ...
  Book(this.book_id,this.book_name,this.version,this.writer,this.publisher,this.publication_date,this.book_type,this.book_picture,this.language,this.price,this.description);
