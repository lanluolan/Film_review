...
void postRequestFunction(String ans, String session_id) async {
  ...
  request.fields.addAll({'book_id': id, 'reading_status': ans});
...
class booknote4 extends StatelessWidget {
  book b1;
  ...
  void getbookinfo() async {
    ...
    try {
      ...
      jinglis = ans.jilings;
      bookzp = 1;
      print("书摘书评成功 ${bookid} ${shupings[0].title}");
    } on DioError catch (e) {
            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                    ...
                    onPressed: () {
                      postRequestFunction("在读", session_id);
                    },
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                    ...
                    onPressed: () {
                      postRequestFunction("想读", session_id);
                    },
                    icon: Icon(Icons.bookmark_add),
                    label: Text("加入想读", style: TextStyle(fontSize: 25))),
              ),
            ],
          ),
        )));
