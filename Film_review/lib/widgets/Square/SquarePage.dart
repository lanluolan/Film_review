...
class SquarePage extends StatefulWidget {
  ...
  List  booklist=[{}];
  List movielist=[{}];
  SquarePage(this.session_id,this.email,this.user_name,this.booklist,this.movielist);
  @override
  _HomeItemDemoPageState createState() => _HomeItemDemoPageState(session_id:session_id,email:email,user_name: user_name,booklist: booklist,movielist: movielist);
}

class _HomeItemDemoPageState extends State<SquarePage> {
  _HomeItemDemoPageState({Key key,this.session_id,this.email,this.user_name,this.booklist,this.movielist}) : super();
  ...
  //TODO 查询用户信息（所有）
  GetUserInfoAll() async {
    var headers = {
      'User-Agent': 'Apifox/1.0.0 (https://www.apifox.cn)'
    };
    var request = http.MultipartRequest('GET',
        Uri.parse('$url/user_query'));
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
    if (response.statusCode == 200) {
      String responseContent = await response.stream.transform(utf8.decoder).join();
      setState((){
        userlistAll = json.decode(responseContent)["content"];
      });
      debugPrint(userData.toString());
      print(await response.stream.bytesToString());
    }
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      ...
                                      Navigator.push<int>(context, MaterialPageRoute(builder: (BuildContext context){
                                        ...
                                        return RecommendPage(recommends,list,books,movies,movie_id,book_id,email,session_id);
                                      }));
                                    },
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      Navigator.of(context).push(MaterialPageRoute(builder: (_) =>
                                          BookReview(session_id,bookreviews,email,like,likes,remark,map,mapthumb,mapremark,mapremarkcontent,mapremark_remark,userlistAll)));
                                    },
                              ...
                              Column(
                                children: [
                                  IconButton(
                                    onPressed: () {
                                      Navigator.push<int>(context, MaterialPageRoute(builder: (BuildContext context){
                                        return MovieReview(session_id,moviereviews,email,likemovie,likesmovie,remarkmovie,mapmovie,mapthumbmovie,mapremarkmovie,mapremarkcontentmovie,mapremark_remarkmovie,userlistAll);
                                      }));
                                    },
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                                onPressed: (){
                                  Navigator.of(context).push(MaterialPageRoute(builder: (_)=>RecommendBookListPage(booklist,email,session_id)));
                                },
                                ...
                                Expanded(
                                  child: Column(
                                    children: <Widget>[
                                      GestureDetector(
                                        onTap: (){
                                          Navigator.of(context).push(MaterialPageRoute(builder: (_)=>RecommendBookListDetail(book,email,session_id)));
                                        },
                                        child: Container(
                                          width: rpx(120),
                                          height: rpx(160),
                                ...
                                Expanded(
                                  child: Column(
                                    children: <Widget>[
                                      GestureDetector(
                                        onTap: (){
                                          Navigator.of(context).push(MaterialPageRoute(builder: (_)=>RecommendBookListDetail(book2,email,session_id)));
                                        },
                                        child: Container(
                                          width: rpx(120),
                                          height: rpx(160),
                                ...
                                Expanded(
                                  child: Column(
                                    children: <Widget>[
                                      GestureDetector(
                                        onTap: (){
                                          Navigator.of(context).push(MaterialPageRoute(builder: (_)=>RecommendBookListDetail(book3,email,session_id)));
                                        },
                                        child: Container(
                                          width: rpx(120),
                                          height:rpx(160),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                                onPressed: (){
                                  Navigator.of(context).push(MaterialPageRoute(builder: (_)=>RecommendMovieListPage(movielist,email,session_id)));
                                },
                                child: Text("更多 >", style: TextStyle(fontSize:rpx(20.0), color: Colors.black38),)
                            )
                          ],
                                ...
                                Expanded(
                                  child: Column(
                                    children: <Widget>[
                                      GestureDetector(
                                        onTap: (){
                                          Navigator.of(context).push(MaterialPageRoute(builder: (_)=>RecommendMovieListDetail(movie,email,session_id)));
                                        },
                                        child: Container(
                                          width: rpx(120),
                                          height: rpx(160),
                                ...
                                Expanded(
                                  child: Column(
                                    children: <Widget>[
                                      GestureDetector(
                                        onTap: (){
                                          Navigator.of(context).push(MaterialPageRoute(builder: (_)=>RecommendMovieListDetail(movie2,email,session_id)));
                                        },
                                        child: Container(
                                          width: rpx(120),
                                          height: rpx(160),
                                ...
                                Expanded(
                                  child: Column(
                                    children: <Widget>[
                                      GestureDetector(
                                        onTap: (){
                                          Navigator.of(context).push(MaterialPageRoute(builder: (_)=>RecommendMovieListDetail(movie3,email,session_id)));
                                        },
                                        child: Container(
                                          width: rpx(120),
                                          height: rpx(160),
